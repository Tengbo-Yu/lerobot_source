...
class CameraWrapper(gym.ObservationWrapper):
    def __init__(self, env: gym.Env):
        ...
        # print(env.observation_space.spaces['state'].keys())
        # print(env.observation_space.spaces['state'].spaces['sensor_data'].keys())
        # print(env.observation_space.spaces['state'].spaces['sensor_data'].spaces['base_camera'].keys())
        # print(env.observation_space.spaces['state'].spaces['sensor_data'].spaces['base_camera'].spaces['rgb'].keys())
        # print(env.observation_space.spaces['state'].spaces['sensor_data'].spaces['hand_camera'].keys())
        # print(env.observation_space.spaces['state'].spaces['sensor_data'].spaces['hand_camera'].spaces['rgb'].keys())
